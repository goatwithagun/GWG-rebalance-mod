...
function NPCRaycastWeaponBase:_fire_raycast(user_unit, from_pos, direction, dmg_mul, shoot_player, spread_mul, autohit_mul, suppr_mul, target_unit)
	if user_unit and alive(user_unit) and target_unit and alive(target_unit) and user_unit:base() and user_unit:base()._tweak_table and user_unit:base()._tweak_table == "heavy_swat_sniper" then
